...
public class GuardarUsuarioServlet extends ProjectoTAWServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (super.redirigirUsuario(request, response, "Administrador", request.getSession())) {
            ...
            this.usuarioService.editarUsuario(idUsuario,username, pass, name, surname, city, address, age, gender, userType);
