...
import proyectoTAW.service.NotificacionService;
...
public class NotificacionesServlet extends ProjectoTAWServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/WEB-INF/jsp/verNotificaciones.jsp").forward(request, response);
    }
